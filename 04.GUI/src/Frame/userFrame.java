...
public class userFrame extends JFrame {
	...
	public userFrame(int flag, String fname) throws SQLException {   //设置flag参数来打开不同的选项卡
		...
		for (Enumeration<User> e = DataProcessing.users.elements(); e.hasMoreElements();) {
			...
			if(u.getName().equalsIgnoreCase(fname)) {      //让自己不显示在下拉框中
				continue;
			}
			name[i++] = u.getName();
		}
		JComboBox cbox1 = new JComboBox(name);
		...
		JComboBox cbox2 = new JComboBox(role);
...
//========================================================================================================================
		...
		JComboBox cbox11 = new JComboBox(name);
			...
			public void mousePressed(MouseEvent e) {
				...
				MouseListener m11 = new MouseAdapter() {
					public void mousePressed(MouseEvent e) {
						...
						cbox11.removeAllItems();            //删除后要刷新下拉列表
						for (Enumeration<User> e1 = DataProcessing.users.elements(); e1.hasMoreElements();) {
							User u=e1.nextElement();
							if(u.getName().equalsIgnoreCase(fname)) {      //让自己不显示在下拉框中
								continue;
							}
							cbox1.addItem(u.getName());
							cbox11.addItem(u.getName());
						}	
...
//========================================================================================================================
		...
		JComboBox cbox3 = new JComboBox(role);
			...
			public void mousePressed(MouseEvent e) {
				...
				MouseListener m11 = new MouseAdapter() {
					public void mousePressed(MouseEvent e) {
						...
						cbox1.removeAllItems();
						cbox11.removeAllItems();            //增加后要刷新下拉列表
						for (Enumeration<User> e1 = DataProcessing.users.elements(); e1.hasMoreElements();) {
							User u=e1.nextElement();
							cbox1.addItem(u.getName());
							cbox11.addItem(u.getName());
