...
public class mainFrame extends JFrame {
	...
	public mainFrame(String name) throws SQLException {
		...
		MouseListener m4 = new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				new fileFrame("upload");//调同一方法，传不同参数
			}
		};
		...
		MouseListener m5 = new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				new fileFrame("download");//调同一方法，传不同参数
			}
		};
		...
		setJMenuBar(menu);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);  //主窗口退出即系统结束
