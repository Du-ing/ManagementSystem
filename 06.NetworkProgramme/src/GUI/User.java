...
public abstract class User {
	...
	public abstract void showMenu(Client client) throws SQLException, IOException;    //显示不同角色对应的菜单并进行其特有的操作
	...
	/*public void showFileList(){
		for (Enumeration<Doc> e = DataProcessing.docs.elements(); e.hasMoreElements();) {
			Doc u=e.nextElement();
			System.out.println(u.getID()+" "+u.getCreator()+" "+u.getTimestamp()+" "+u.getDescription()+" "+u.getFilename());
		}
	}*/
